namespace SCE
{
    ...
    public class ZoneCameraTrackComponent : ComponentBase<Camera>, IUpdate
    {
        ...
        public ZoneCameraTrackComponent(SCEObject obj, Rect2DInt boundingArea, Vector2Int zoneDimensions)
            : base()
        {
            if (zoneDimensions <= 0)
        ...
        /// </summary>
        public Rect2DInt BoundingArea { get; set; }
        ...
        private Vector2Int ObjectAlignedZonePosition => Object.GlobalGridPosition() + -AnchorUtils.DimensionFix(ZoneAnchor, ZoneDimensions) + ZonePosition;
        ...
        public void Update()
        {
            Holder.Position = (Vector2)(BoundObjectAlignedZonePosition + ZoneDimensions.Midpoint() + -AnchorUtils.DimensionFix(CameraAnchor, Holder.Dimensions) + CameraPosition);
        }
    }
}
